...
### Interfaz Principal
![Tienda](./screenshots/home.png)
*Catálogo optimizado por país con precios localizados y stock en tiempo real.*

### Panel de Administración (Big Nana)
![Admin Panel](./screenshots/admin-panel.png)
*Dashboard completo: gestión de órdenes, usuarios, inventario y análisis.*

### Checkout Seguro
![Checkout](./screenshots/checkout.png)
*Flujo multi-pasarela con validación de datos y manejo de errores.*

### Sistema de Órdenes
![Órdenes](./screenshots/orders.png)
*Historial de transacciones con estado, método de pago y comprobante.*
...
- **Sitio Live:** [https://thenanastore.com](https://thenanastore.com)
- **Portafolio GitHub:** [enlace-a-tu-portafolio-repo]
